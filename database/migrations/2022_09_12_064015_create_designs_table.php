...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('designs', function (Blueprint $table) {
            ...
            $table->integer('sub_cate_id')->default(17);
            $table->string('title');
        ...
        DB::statement('ALTER TABLE `designs` DROP PRIMARY KEY, ADD PRIMARY KEY (`id`, `language`) USING BTREE');
        ...
        DB::table('designs')->insert([
            [
                ...
                'thumbnail_title' => '',
                'thumbnail_link' => 'images/design-1.png',
                'priority' => 1,
                'iframe' => '',
                'redirect' => null,
                'freetag' => ''
